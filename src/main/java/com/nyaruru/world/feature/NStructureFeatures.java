...
import com.nyaruru.world.structure.loot_chest.NDarkForestLootChestPiece;
import com.nyaruru.world.structure.loot_chest.NDarkForestLootChestStructure;
    ...
    public static void setupStructures() {
        {
            ...
            CONFIGURED_DARK_FOREST_LOOT_CHEST = DARK_FOREST_LOOT_CHEST.get().configured(NoFeatureConfig.INSTANCE);

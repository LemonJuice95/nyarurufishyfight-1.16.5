...
import com.nyaruru.world.feature.GenStructures;
...
public class NyaruruFishyFight {
    ...
    public NyaruruFishyFight(){
        ...
        NStructureRegister.STRUCTURE_FEATURES.register(FMLJavaModLoadingContext.get().getModEventBus());

        MinecraftForge.EVENT_BUS.addListener(EventPriority.NORMAL, GenStructures::addDimensionalSpacing);

...
public class NBiomeRegister {
    ...
    public static void registerBiomes(final FMLCommonSetupEvent ev) {
        registerBiome(DARK_FOREST.get(), BiomeManager.BiomeType.COOL, 50, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.OVERWORLD);
    }
    ...
    public static void biomeModification(final BiomeLoadingEvent event) {
        ...
        if(biome != null) {
            ...
            NStructureRegister.addStructureToBiome(event, biomeKey);
        }
    }
